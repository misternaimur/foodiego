...
// Define and export SelectedOption so FoodCard can use it
...
export const FoodCard: React.FC<FoodCardProps> = ({
  ...
  return (
    <div 
      ...
      className="group relative bg-white rounded-3xl border border-gray-100 shadow-xs hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col justify-between cursor-pointer"
    >
      <div>
        {/* Top Image Container */}
