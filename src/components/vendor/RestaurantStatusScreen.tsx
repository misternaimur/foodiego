...
import { Clock, XCircle, MapPin, Calendar, Mail, LogOut, Store, Sparkles } from "lucide-react";
import { useApp } from "@/context/AppContext";

type RestaurantApplicationStatus = "pending" | "rejected";

interface RestaurantStatusScreenProps {
...
const STATUS_COPY = {
  pending: {
    ...
    body: "Thanks for applying to become a Foodiego restaurant partner. Our team is reviewing your details and will notify you as soon as a decision is made — usually within 24–48 hours.",
    ...
    <main className="flex-1 bg-white flex items-center justify-center px-4 py-12 sm:py-16">
      ...
      >
        ...
        <div className="mt-7 space-y-3 rounded-2xl border border-gray-100 bg-gray-50/60 p-5 text-left">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-sm font-semibold text-gray-800">{restaurantName}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white text-emerald-600 ring-1 ring-gray-200/70">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-sm font-semibold text-gray-800">{address}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white text-emerald-600 ring-1 ring-gray-200/70">
        ...
        <p className="mt-6 inline-flex items-center justify-center gap-1.5 text-xs text-gray-400">
          ...
          Hi {ownerName}, we&apos;ll be in touch soon.
        </p>
      </motion.div>
    </main>
  );
