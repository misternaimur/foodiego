...
const defaultSteps: HowItWorksStep[] = [
  {
    ...
    description:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry Ipsum has.',
  ...
  },
  {
    ...
    icon: <Bike className="w-5 h-5 text-emerald-300" />,
  },
];
    ...
    <section className="w-full bg-transparent py-20 lg:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-[#15462D] rounded-[2.5rem] pt-14 pb-2 px-6 sm:px-12 lg:px-16 text-center text-white shadow-2xl border border-emerald-300/10">
          ...
          {/* Ambient Background Green & Purple Glows */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-[2.5rem]">
            <div className="absolute top-1/4 -left-32 w-80 h-80 bg-emerald-300/15 rounded-full blur-[100px]" />
            <div className="absolute bottom-1/3 -right-32 w-80 h-80 bg-purple-400/15 rounded-full blur-[100px]" />
          </div>

          <div className="relative z-10 max-w-2xl mx-auto mb-12">

            {/* Top Pill Tag */}
            <div className="inline-flex items-center justify-center bg-emerald-400 text-[#123B27] px-4 py-1.5 rounded-full mb-4 shadow-sm">
            ...
            <p className="text-xs sm:text-sm text-emerald-50/70 font-normal leading-relaxed max-w-md mx-auto">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
            {defaultSteps.map((step) => (
              <div
                key={step.number}
                className="relative bg-[#1B5A3A]/80 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-between text-center shadow-lg transition-all duration-300 hover:border-emerald-300/40"
              >
                <div>

                  {/* Icon Circle */}
                  <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mb-6 shadow-inner mx-auto border border-emerald-200/10">
                    {step.icon}
                  </div>
                  ...
                  <p className="text-xs text-emerald-50/65 leading-relaxed">
                    {step.description}
                  </p>
                </div>
                ...
                {/* Number Badge */}
                <div className="mt-8">
                  <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-emerald-300 text-[#123B27] font-black text-xs shadow-md">
                    {step.number}
                  </span>
                </div>
              </div>
          ...
          <div className="relative z-10 flex flex-col items-center gap-4 pt-2 mb-16">
            ...
            <p className="text-xs sm:text-sm font-medium text-emerald-50/80">
              Get{' '}
