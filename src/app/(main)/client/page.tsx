...
export default function ClientOverviewPage() {
  ...
  const stats = [
    ...
    { label: "Favorites", value: isMounted ? String(favorites.length) : "0", icon: Heart, color: "bg-rose-50 text-rose-600" },
    { label: "Total Spent", value: "$412.80", icon: DollarSign, color: "bg-sky-600 text-sky-600" },
  ];
    ...
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">
          Welcome back{isMounted && user?.name ? `, ${user.name.split(" ")[0]}` : ""}!
        </h1>
